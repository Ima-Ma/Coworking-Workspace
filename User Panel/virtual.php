                        ...
                        <div class="card rounded shadow position-relative flex-fill <?php echo $cardClass; ?>" style="height: 100%;">
                            ...
                            <div class="p-5 pt-0">
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    <img src="<?php echo '../admin Panel/admin/image_virtual/' . htmlspecialchars($rows['image']); ?>" alt="<?php echo htmlspecialchars($rows['title']); ?>" class="img-fluid" style="object-fit: cover; height: 200px; width: 100%;">
                                </div>
                                <?php echo $statusMessage; ?>
                                <a href="booking2.php?id=<?php echo $rows['id']; ?>" class="btn btn-primary py-2 px-4 mt-4 w-100 <?php echo $status == 0 ? '' : 'disabled'; ?>">Book Now</a>
                            </div>
                        </div>
                    </div>
                    <?php
